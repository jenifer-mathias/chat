...
import br.com.jms.chat.NavActivity
...
class NavigationTest {
    ...
    private fun navigateToHome() {
        ...
        composeTestRule.onNode(hasText("aula de redes") and isInDrawer()).performClick()
    }
